...
chord <- chorddiag(
  ...
  tooltipGroupConnector = tooltipGroupConnector, groupColors = names(regions.ordered), margin = margin, 
  tickInterval = tickInterval, groupThickness = 0.07, precision = precision,
